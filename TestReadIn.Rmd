...
#-------------------------------------------------------    
emoResult <- read.csv(file="Verhalen_Emotional+Arousal_September+6%2C+2019_08.37.csv", 
...
#------------------------------------------------------- 
litResult <- read.csv(file="Verhalen_Literariness_September+5%2C+2019_11.49.csv", 
                  header = TRUE, sep = ",", stringsAsFactors = FALSE)
