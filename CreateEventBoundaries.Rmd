...
DH2Vmarked <- read.csv(file = "thesis/emoDH2VFinal_eventMarked.csv", header = T, sep = ",", stringsAsFactors = FALSE)
DMOmarked <- read.csv(file = "thesis/emoDMOFinal_eventMarked.csv", header = T, sep = ",", stringsAsFactors = FALSE)
DM2Vmarked <- read.csv(file = "thesis/emoDM2VFinal_eventMarked.csv", header = T, sep = ",", stringsAsFactors = FALSE)
