...
```{r t test for behavioral results}
rater <- read.delim("~/desktop/rater_group_behavioral.csv", header = TRUE, sep = ",", stringsAsFactors = TRUE)
fmri <- read.delim("~/desktop/fMRI_group_behavioral.csv", header = TRUE, sep = ",", stringsAsFactors = TRUE)
